      ...
      <div className="px-8 space-y-6">
        ...
        <div className="bg-white p-4 rounded-2xl shadow-sm flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <p className="font-bold text-[#2D3142] text-sm">Farmácia</p>
              <p className="text-[10px] text-slate-400 font-bold">11 Abr 2026</p>
            </div>
          </div>
          <p className="font-black text-red-500">- R$ 89,90</p>
        </div>
        <button className="w-full py-6 bg-[#E8A87C] text-white rounded-[2rem] font-black flex items-center justify-center gap-3 shadow-xl">
